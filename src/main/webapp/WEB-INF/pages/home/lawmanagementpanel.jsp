...
<div id="addLawWin">
    <form id="addLawForm" class="control-form">
        ...
        <div style="padding-top: 2px; margin-right: 2px">
            <script id="containerAdd" name="lawDetails" type="text/plain"></script>
        </div>
...
<!--修改窗口-->
<div id="editLawWin">
    <form id="editLawForm" class="control-form">
        <table class="table_list" style="text-align: right;margin:3px;width:99%">
            <tr>
                <th width="120"><label class="control-label required-mark" style="width:100px"
                                       required="required">法制校园标题
        ...
        <div style="padding-top: 2px; margin-right: 2px">
            <script id="containerEdit" name="lawDetails" type="text/plain"></script>
        </div>

    </form>

    <div id="editLawWinFooter" style="text-align:center;padding:5px">
        <a id="editLawWinSubmitBtn" href="javascript:void(0);" iconCls="icon-ok" class="easyui-linkbutton"
           style="margin-right:20px;">
            确认
        </a>
        <a id="editLawWinCloseBtn" href="javascript:void(0);" iconCls="icon-cancel" style="margin-left:20px;"
           class="easyui-linkbutton">
            取消
        </a>
    </div>
