...
<head>
    ...
    <script type="text/javascript"
            src="<c:url value="/static/js/home/teachermanagementpanel.js"/>"></script>
</head>
...
<div id="addTeacherWin">
    <form id="addTeacherForm" class="control-form">
        ...
        <div style="padding-top: 2px; margin-right: 2px">
            <script id="containerAdd" name="teacherDetails" type="text/plain"></script>
        </div>
...
<div id="editTeacherWin">
    <form id="editTeacherForm" class="control-form">
        ...
        <div style="padding-top: 2px; margin-right: 2px">
            <script id="containerEdit" name="teacherDetails" type="text/plain"></script>
        </div>
