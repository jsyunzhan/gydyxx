...
<head>
    ...
    <script type="text/javascript" src="${APP_PATH}/static/js/data/zpzs.js"></script>
    <title>作品展示</title>
</head>
<body>
<div class="wrapper">
    ...
    <div class="content">
        ...
        <div class="infor clearfix">
            ...
            <div class="leftSide">
                <div class="leftClass">
                    ...
                    <div class="leftClass_con">
                        ...
                        <a href="${APP_PATH}/pc/zyshaonian/zpzs.jsp"><p class="leftChild choosen">作品展示<span></span></p></a>
                    </div>
                </div>
                <div class="history">
            ...
            <div class="news">
                <div class="title_news">
                    作品展示
                    <a href="javascript:;">您当前的位置：<b>首页-致用少年-作品展示</b></a>
                </div>
