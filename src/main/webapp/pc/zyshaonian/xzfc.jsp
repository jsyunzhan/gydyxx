...
<head>
    ...
    <script type="text/javascript" src="${APP_PATH}/static/js/data/xzfc.js"></script>
    <title>学子风采</title>
</head>
<body>
<div class="wrapper">
    ...
    <div class="content">
        ...
        <div class="infor clearfix">
            ...
            <div class="leftSide">
                <div class="leftClass">
                    ...
                    <div class="leftClass_con">
                        ...
                        <a href="${APP_PATH}/pc/zyshaonian/gqxjh.jsp"><p class="leftChild">国旗下讲话<span></span></p></a>
                        <a href="${APP_PATH}/pc/zyshaonian/xzfc.jsp"><p class="leftChild choosen">学子风采<span></span></p></a>
            ...
            <div class="news">
                <div class="title_news">
                    学子风采
                    <a href="javascript:;">您当前的位置：<b>首页-致用少年-学子风采</b></a>
                </div>
