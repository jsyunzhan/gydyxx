...
<head>
    ...
    <script type="text/javascript" src="${APP_PATH}/static/js/data/gqxjh.js"></script>
    <title>国旗下讲话</title>
</head>
<body>
<div class="wrapper">
    ...
    <div class="content">
        ...
        <div class="infor clearfix">
            ...
            <div class="leftSide">
                <div class="leftClass">
                    ...
                    <div class="leftClass_con">
                        <a href="${APP_PATH}/pc/zyshaonian/zyy.jsp"><p class="leftChild">致用邑<span></span></p></a>
                        <a href="${APP_PATH}/pc/zyshaonian/gqxjh.jsp"><p class="leftChild choosen">国旗下讲话<span></span></p></a>
                        <a href="${APP_PATH}/pc/zyshaonian/xzfc.jsp"><p class="leftChild">学子风采<span></span></p></a>
                        <a href="${APP_PATH}/pc/zyshaonian/zpzs.jsp"><p class="leftChild">作品展示<span></span></p></a>
                    </div>
                </div>
                <div class="history">
            ...
            <div class="news">
                <div class="title_news">
                    国旗下讲话
                    <a href="javascript:;">您当前的位置：<b>首页-致用少年-国旗下讲话</b></a>
                </div>
