...
<head>
    ...
    <script type="text/javascript" src="${APP_PATH}/static/js/data/zyy.js"></script>
    <title>致用邑</title>
</head>
<body>
<div class="wrapper">
    ...
    <div class="content">
        ...
        <div class="infor clearfix">
            ...
            <div class="leftSide">
                <div class="leftClass">
                    ...
                    <div class="leftClass_con">
                        <a href="${APP_PATH}/pc/zyshaonian/zyy.jsp"><p class="leftChild choosen">致用邑<span></span></p></a>
            ...
            <div class="news">
                <div class="title_news">
                    致用邑
                    <a href="javascript:;">您当前的位置：<b>首页-致用少年-致用邑</b></a>
                </div>
