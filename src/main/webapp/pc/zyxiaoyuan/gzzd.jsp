...
<head>
    ...
    <script type="text/javascript" src="${APP_PATH}/static/js/data/gzzd.js"></script>
    <title>规章制度</title>
</head>
<body>
<div class="wrapper">
            ...
            <div class="leftSide">
                <div class="leftClass">
                    ...
                    <div class="leftClass_con">
                        ...
                        <a href="${APP_PATH}/pc/zyxiaoyuan/gzzd.jsp"><p class="leftChild choosen">规章制度<span></span></p></a>
