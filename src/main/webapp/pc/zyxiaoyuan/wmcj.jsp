...
<head>
    ...
    <script type="text/javascript" src="${APP_PATH}/static/js/data/wmjs.js"></script>
    <title>文明建设</title>
</head>
<body>
<div class="wrapper">
            ...
            <div class="leftSide">
                <div class="leftClass">
                    ...
                    <div class="leftClass_con">
                        ...
                        <a href="${APP_PATH}/pc/zyxiaoyuan/wmcj.jsp"><p class="leftChild choosen">文明创建<span></span></p></a>
