...
<head>
    ...
    <script type="text/javascript" src="${APP_PATH}/static/js/data/xyxw.js"></script>
    <title>校园新闻</title>
</head>
<body>
<div class="wrapper">
            ...
            <div class="leftSide">
                <div class="leftClass">
                    ...
                    <div class="leftClass_con">
                        ...
                        <a href="${APP_PATH}/pc/zyxiaoyuan/xyxw.jsp"><p class="leftChild choosen">校园新闻<span></span></p></a>
