...
<head>
    ...
    <script type="text/javascript" src="${APP_PATH}/static/js/data/jxxq.js"></script>
    <title>家校心桥</title>
</head>
<body>
<div class="wrapper">
    ...
    <div class="content">
        ...
        <div class="infor clearfix">
            ...
            <div class="leftSide">
                <div class="leftClass">
                    ...
                    <div class="leftClass_con">
                        <a href="${APP_PATH}/pc/zmjiaxiao/jxxq.jsp"><p class="leftChild choosen">家校心桥<span></span></p></a>
            ...
            <div class="news">
                <div class="title_news">
                    家校心桥
                    <a href="javascript:;">您当前的位置：<b>首页-致睦家校-家校心桥</b></a>
                </div>
