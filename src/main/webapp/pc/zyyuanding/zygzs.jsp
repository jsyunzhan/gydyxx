...
<head>
    ...
    <script type="text/javascript" src="${APP_PATH}/static/js/data/zygzs.js"></script>
    <title>致远工作室</title>
</head>
<body>
<div class="wrapper">
    ...
    <div class="content">
        ...
        <div class="infor clearfix">
            ...
            <div class="leftSide">
                <div class="leftClass">
                    ...
                    <div class="leftClass_con">
                        <a href="${APP_PATH}/pc/zyyuanding/msfc.jsp"><p class="leftChild">名师风采<span></span></p></a>
                        <a href="${APP_PATH}/pc/zyyuanding/zygzs.jsp"><p class="leftChild choosen">致远工作室<span></span></p></a>
                        <a href="${APP_PATH}/pc/zyyuanding/jxzy.jsp"><p class="leftChild">教学资源<span></span></p></a>
                    </div>
                </div>
                <div class="history">
            ...
            <div class="news">
                <div class="title_news">
                    致远工作室
                    <a href="javascript:;">您当前的位置：<b>首页-致用园丁-致远工作室</b></a>
                </div>
