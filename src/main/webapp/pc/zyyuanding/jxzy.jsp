...
<head>
    ...
    <script type="text/javascript" src="${APP_PATH}/static/js/data/jxzy.js"></script>
    <title>教学资源</title>
</head>
<body>
<div class="wrapper">
    ...
    <div class="content">
        ...
        <div class="infor clearfix">
            ...
            <div class="leftSide">
                <div class="leftClass">
                    ...
                    <div class="leftClass_con">
                        ...
                        <a href="${APP_PATH}/pc/zyyuanding/jxzy.jsp"><p class="leftChild choosen">教学资源<span></span></p></a>
                    </div>
                </div>
                <div class="history">
            ...
            <div class="news">
                <div class="title_news">
                    教学资源
                    <a href="javascript:;">您当前的位置：<b>首页-致用园丁-教学资源</b></a>
                </div>
