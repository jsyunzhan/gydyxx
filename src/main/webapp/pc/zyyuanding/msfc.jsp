...
<head>
    ...
    <script type="text/javascript" src="${APP_PATH}/static/js/data/msfc.js"></script>
    <title>名师风采</title>
</head>
<body>
<div class="wrapper">
    ...
    <div class="content">
        ...
        <div class="infor clearfix">
            ...
            <div class="leftSide">
                <div class="leftClass">
                    ...
                    <div class="leftClass_con">
                        <a href="${APP_PATH}/pc/zyyuanding/msfc.jsp"><p class="leftChild choosen">名师风采<span></span></p></a>
                        <a href="${APP_PATH}/pc/zyyuanding/zygzs.jsp"><p class="leftChild">致远工作室<span></span></p></a>
            ...
            <div class="news">
                <div class="title_news">
                    名师风采
                    <a href="javascript:;">您当前的位置：<b>首页-致用园丁-名师风采</b></a>
                </div>
