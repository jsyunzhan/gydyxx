...
<head>
    ...
    <script type="text/javascript" src="${APP_PATH}/static/js/data/xbpx.js"></script>
    <title>校本培训</title>
</head>
<body>
<div class="wrapper">
    ...
    <div class="content">
        ...
        <div class="infor clearfix">
            ...
            <div class="leftSide">
                <div class="leftClass">
                    ...
                    <div class="leftClass_con">
                        ...
                        <a href="${APP_PATH}/pc/zyxueyuan/xbpx.jsp"><p class="leftChild choosen">校本培训<span></span></p></a>
                        <a href="${APP_PATH}/pc/zyxueyuan/jyky.jsp"><p class="leftChild">教育科研<span></span></p></a>
                        <a href="${APP_PATH}/pc/zyxueyuan/zykt.jsp"><p class="leftChild">致用课堂<span></span></p></a>
                    </div>
                </div>
                <div class="history">
            ...
            <div class="news">
                <div class="title_news">
                    校本培训
                    <a href="javascript:;">您当前的位置：<b>首页-致用学院-校本培训</b></a>
                </div>
