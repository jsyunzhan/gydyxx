...
<head>
    ...
    <script type="text/javascript" src="${APP_PATH}/static/js/data/jyky.js"></script>
    <title>教育科研</title>
</head>
<body>
<div class="wrapper">
    ...
    <div class="content">
        ...
        <div class="infor clearfix">
            ...
            <div class="leftSide">
                <div class="leftClass">
                    ...
                    <div class="leftClass_con">
                        ...
                        <a href="${APP_PATH}/pc/zyxueyuan/jyky.jsp"><p class="leftChild choosen">教育科研<span></span></p></a>
            ...
            <div class="news">
                <div class="title_news">
                    教育科研
                    <a href="javascript:;">您当前的位置：<b>首页-致用学院-教育科研</b></a>
                </div>
