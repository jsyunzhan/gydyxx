...
<head>
    ...
    <script type="text/javascript" src="${APP_PATH}/static/js/data/ktyj.js"></script>
    <title>课题研究</title>
</head>
<body>
<div class="wrapper">
    ...
    <div class="content">
        ...
        <div class="infor clearfix">
            ...
            <div class="leftSide">
                <div class="leftClass">
                    ...
                    <div class="leftClass_con">
                        <a href="${APP_PATH}/pc/zyxueyuan/ktyj.jsp"><p class="leftChild choosen">课题研究<span></span></p></a>
            ...
            <div class="news">
                <div class="title_news">
                    课题研究
                    <a href="javascript:;">您当前的位置：<b>首页-致用学院-课题研究</b></a>
                </div>
