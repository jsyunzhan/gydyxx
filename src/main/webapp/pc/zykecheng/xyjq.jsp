...
<head>
    ...
    <script type="text/javascript" src="${APP_PATH}/static/js/data/xyjq.js"></script>
    <title>校园节庆</title>
</head>
<body>
<div class="wrapper">
    ...
    <div class="content">
        ...
        <div class="infor clearfix">
            ...
            <div class="leftSide">
                <div class="leftClass">
                    ...
                    <div class="leftClass_con">
                        <a href="${APP_PATH}/pc/zykecheng/xyjq.jsp"><p class="leftChild choosen">校园节庆<span></span></p></a>
                        <a href="${APP_PATH}/pc/zykecheng/jpst.jsp"><p class="leftChild">精品社团<span></span></p></a>
                        <a href="${APP_PATH}/pc/zykecheng/bbkc.jsp"><p class="leftChild">班本课程<span></span></p></a>
                    </div>
                </div>
                <div class="history">
            ...
            <div class="news">
                <div class="title_news">
                    校园节庆
                    <a href="javascript:;">您当前的位置：<b>首页-致用课程-校园节庆</b></a>
                </div>
