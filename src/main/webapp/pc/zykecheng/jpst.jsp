...
<head>
    ...
    <script type="text/javascript" src="${APP_PATH}/static/js/data/jpst.js"></script>
    <title>精品社团</title>
</head>
<body>
<div class="wrapper">
    ...
    <div class="content">
        ...
        <div class="infor clearfix">
            ...
            <div class="leftSide">
                <div class="leftClass">
                    ...
                    <div class="leftClass_con">
                        <a href="${APP_PATH}/pc/zykecheng/xyjq.jsp"><p class="leftChild">校园节庆<span></span></p></a>
                        <a href="${APP_PATH}/pc/zykecheng/jpst.jsp"><p class="leftChild choosen">精品社团<span></span></p></a>
            ...
            <div class="news">
                <div class="title_news">
                    精品社团
                    <a href="javascript:;">您当前的位置：<b>首页-致用课程-精品社团</b></a>
                </div>
