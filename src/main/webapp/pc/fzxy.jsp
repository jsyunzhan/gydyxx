...
<head>
    ...
    <script type="text/javascript" src="../static/js/data/fzxy.js"></script>
    <title>法制校园</title>
</head>
<body>
<div class="wrapper">
    ...
    <div class="content">
        ...
        <div class="infor clearfix">
            ...
            <div class="leftSide">
                <div class="leftClass">
                    ...
                    <div class="leftClass_con">
                        ...
                        <a href="${APP_PATH}/pc/xyxw.jsp"><p class="leftChild">校园新闻<span></span></p></a>
                        ...
                        <a href="${APP_PATH}/pc/fzxy.jsp"><p class="leftChild choosen">法治校园<span></span></p></a>
            ...
            <div class="news">
                <div class="title_news">
                    法制校园
                    <a href="javascript:;">您当前的位置：<b>首页-致用校园-法制校园</b></a>
                </div>
