...
<head>
    ...
    <script type="text/javascript" src="../static/js/data/gzzd.js"></script>
    <title>规章制度</title>
</head>
<body>
<div class="wrapper">
    ...
    <div class="content">
        ...
        <div class="infor clearfix">
            ...
            <div class="leftSide">
                <div class="leftClass">
                    ...
                    <div class="leftClass_con">
                        ...
                        <a href="${APP_PATH}/pc/gzzd.jsp"><p class="leftChild choosen">规章制度<span></span></p></a>
            ...
            <div class="news">
                <div class="title_news">
                    规章制度
                    <a href="javascript:;">您当前的位置：<b>首页-致用校园-规章制度</b></a>
                </div>
